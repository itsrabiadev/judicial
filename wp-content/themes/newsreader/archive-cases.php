            ...
            <div class="cs-posts-area__outer">
                ...
                >
                    ...
                    while (have_posts()) {
                        ...
                        if ( $videoid ) {
                            $backgroundImage = "http://img.youtube.com/vi/{$videoid}/sddefault.jpg";
                        } else {
                            $backgroundImage = !empty($thumbnail) ?$thumbnail:  $defaultImage;
                        }

                        $options['image_url'] = !empty($backgroundImage)?$backgroundImage: $defaultImage;
