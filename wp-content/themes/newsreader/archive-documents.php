...
get_header(); 
$defaultImagePath = get_theme_file_uri('assets/images/section-title-bg-document-archives.jpg');
...
<style>
    ...
    article.documents .cs-overlay-ratio:not(.cs-ratio-original) .cs-overlay-background img{
        object-fit: cover;
    }
</style>
<div id="primary" class="cs-content-area">
    ...
    <?php get_template_part( 'template-parts/archive/document-filter-form' ); ?>
