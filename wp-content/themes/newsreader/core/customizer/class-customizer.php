	...
	class CSCO_Customizer {
		...
		public function customizer_controls_enqueue_scripts() {
			...
			wp_localize_script( 'cs-customizer', 'cscoCustomizerConfig', array(
				...
				'advanced_settings'    => esc_html__( 'Advanced settings', 'newsreader' ),
				'noFileSelected'       => esc_html__( 'No File Selected', 'newsreader' ),
				'remove'               => esc_html__( 'Remove', 'newsreader' ),
				'default'              => esc_html__( 'Default', 'newsreader' ),
				'selectFile'           => esc_html__( 'Select File', 'newsreader' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'newsreader' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'newsreader' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'newsreader' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'newsreader' ),
			) );
