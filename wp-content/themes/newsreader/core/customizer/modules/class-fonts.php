...
if ( ! class_exists( 'CSCO_Customizer_Fonts' ) ) {
	...
	final class CSCO_Customizer_Fonts {
		...
		public static function get_all_variants() {
			return array(
				'100'       => esc_html__( 'Ultra-Light 100', 'newsreader' ),
				'100light'  => esc_html__( 'Ultra-Light 100', 'newsreader' ),
				'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'newsreader' ),
				'200'       => esc_html__( 'Light 200', 'newsreader' ),
				'200italic' => esc_html__( 'Light 200 Italic', 'newsreader' ),
				'300'       => esc_html__( 'Book 300', 'newsreader' ),
				'300italic' => esc_html__( 'Book 300 Italic', 'newsreader' ),
				'400'       => esc_html__( 'Normal 400', 'newsreader' ),
				'regular'   => esc_html__( 'Normal 400', 'newsreader' ),
				'italic'    => esc_html__( 'Normal 400 Italic', 'newsreader' ),
				'500'       => esc_html__( 'Medium 500', 'newsreader' ),
				'500italic' => esc_html__( 'Medium 500 Italic', 'newsreader' ),
				'600'       => esc_html__( 'Semi-Bold 600', 'newsreader' ),
				'600bold'   => esc_html__( 'Semi-Bold 600', 'newsreader' ),
				'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'newsreader' ),
				'700'       => esc_html__( 'Bold 700', 'newsreader' ),
				'700italic' => esc_html__( 'Bold 700 Italic', 'newsreader' ),
				'800'       => esc_html__( 'Extra-Bold 800', 'newsreader' ),
				'800bold'   => esc_html__( 'Extra-Bold 800', 'newsreader' ),
				'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'newsreader' ),
				'900'       => esc_html__( 'Ultra-Bold 900', 'newsreader' ),
				'900bold'   => esc_html__( 'Ultra-Bold 900', 'newsreader' ),
				'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'newsreader' ),
			);
		}
