...
<div id="primary" class="cs-content-area">
    ...
    <?php do_action('csco_main_before'); ?>
        ...
        <?php if ((isset($_GET['taxonomy']) && $_GET['taxonomy'] === 'category')) : global $wp_query; ?>
            <header class="page-header">
                <div class="cs-page__header ">
                    <h1 class="cs-page__title"><span>News</span></h1>
                    <div class="cs-page__archive-count" style="text-transform: lowercase; font-size: var(--cs-font-post-meta-size);"><?php echo $wp_query->found_posts; ?> posts</div>
                </div>
            </header>
        <?php endif; ?>
        <?php
